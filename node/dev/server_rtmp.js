...
// Update the URL to use the RTMP protocol
const RTMP_URL = "rtmp://admin:Mk123456@192.168.1.111:1935/live/stream"; // Replace with your RTMP URL
...
const startStreaming = () => {
  console.log("Starting FFmpeg to stream RTMP to HLS...");

  const ffmpegCommand = [
    "-i", RTMP_URL,                // RTMP input URL
